...
def main():
    ...
    try:
        ...
        print("\nLogin credentials:")
        print("  [REDACTED_OLD_SUPERADMIN_EMAIL]  / [REDACTED_OLD_SUPERADMIN_PASSWORD]")
        print("  [REDACTED_ADMIN_EMAIL]       / [REDACTED_ADMIN_PASSWORD]")
        print("  [REDACTED_STAFF_EMAIL]       / [REDACTED_STAFF_PASSWORD]")
        print("  [REDACTED_CUSTOMER_EMAIL]    / [REDACTED_CUSTOMER_PASSWORD]")
